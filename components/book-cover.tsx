...
export function BookCover({ book }: BookCoverProps) {
  return (
    <article className="group rounded-[2rem] bg-white p-4 shadow-xl shadow-[#7C5CBF]/10 transition hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#7C5CBF]/15 lg:p-3.5">
      <div className={`relative min-h-72 overflow-hidden rounded-[1.5rem] bg-gradient-to-br ${book.gradient} p-6 text-white lg:min-h-[17rem] lg:p-5`}>
        ...
        <div className="relative flex h-full min-h-60 flex-col justify-between lg:min-h-56">
